// api/save-chat.js (final dengan ekstraksi ringkasan)
...
module.exports = async function handler(req, res) {
  ...
  // 2. Deteksi apakah ini pesan ringkasan akhir sesi (latihan atau PR)
  ...
  if (isSummary) {
    // Ekstraksi data dari ringkasan (mendukung ID dan EN)
